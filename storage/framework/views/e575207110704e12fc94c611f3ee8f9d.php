...
<a href="<?php echo e(route('walletshared.create')); ?>" class="btn btn-primary mb-3">Adicionar Nova Compartilhamento de Carteira</a>
    ...
    <div class="card-body">
        <table class="table table-sm table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('walletshared.edit', $walletSharedTo->id)); ?>" class="btn btn-warning btn-sm">Editar</a>
                    <button class="btn btn-danger btn-sm btn-delete" data-id="<?php echo e($walletSharedTo->id); ?>">Excluir</button>
                    <form id="delete-form-<?php echo e($walletSharedTo->id); ?>" action="<?php echo e(route('walletshared.destroy', $walletSharedTo->id)); ?>" method="POST" style="display:none;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/psf/General/FeevaleProject/cgbBudgetAdminLTE/resources/views/walletshared/index.blade.php ENDPATH**/ ?>