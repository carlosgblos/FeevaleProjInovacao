<?php $__env->startSection('title', 'Editar Movimento'); ?>
...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('movement.update', $movement->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select name="id_wallet" id="wallet_id" class="form-control" onchange="loadMovementTypes()">
                        <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($wallet->id); ?>" <?php echo e($movement->id_wallet == $wallet->id ? 'selected' : ''); ?>><?php echo e($wallet->description); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="id_movement_type" id="movement_type_id" class="form-control">
                        ...
                        <option value="<?php echo e($type->id); ?>" <?php echo e($movement->id_movement_type == $type->id ? 'selected' : ''); ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" class="form-control" value="<?php echo e($movement->description); ?>" placeholder="Descrição do Movimento">
                </div>

                <div class="form-group">
                    <label for="transaction_type">Tipo de Transação</label>
                    <select name="transaction_type" class="form-control">
                        <option value="C" <?php echo e($movement->transaction_type == 'C' ? 'selected' : ''); ?>>Crédito</option>
                        <option value="D" <?php echo e($movement->transaction_type == 'D' ? 'selected' : ''); ?>>Débito</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="vlr">Valor</label>
                    <input type="text" name="vlr" id="vlr" class="form-control" value="<?php echo e(number_format($movement->vlr, 2, ',', '.')); ?>" placeholder="Valor">
                </div>

                <div class="form-group">
                    <label for="transaction_at">Data da Transação</label>
                    <input type="text" name="transaction_at" id="transaction_at" class="form-control" value="<?php echo e($movement->transaction_at); ?>" placeholder="Data da Transação">
                </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/psf/General/FeevaleProject/cgbBudgetAdminLTE/resources/views/movement/edit.blade.php ENDPATH**/ ?>